...
- [`<*T>::read_unaligned`][orig]
- [`NonNull::read_unaligned`]

# Similar Functions

- [`crate::read_unaligned`]
- [`Pointer::read_unaligned`]
- [`NonNullPointer::read_unaligned`]
...
let unaligned = Pointer::from_raw_const(&raw const packed.unaligned);
...
fn read_usize(x: &[u8]) -> usize {
  ...
  let ptr = Pointer::from_raw_const(x.as_ptr()).cast::<usize>();
