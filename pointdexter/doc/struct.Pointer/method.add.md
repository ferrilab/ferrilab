...
This can only move the pointer forward (or not move it). If you need to move
...
Consider using [`wrapping_add`] instead if these constraints are difficult to
...
unsafe {
  assert_eq!(ptr.add(1).read(), b'2');
  assert_eq!(ptr.add(2).read(), b'3');
}
```

[0]: https://doc.rust-lang.org/core/ptr/index.html#provenance
[1]: https://doc.rust-lang.org/core/ptr/index.html#allocation
[orig]: https://doc.rust-lang.org/std/primitive.pointer.html#method.add
